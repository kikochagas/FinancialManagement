...
describe("date-parser", () => {
  it("parses YYYY-MM-DD", () => {
    expect(parseDateStrict("2026-08-16")).toEqual({
      valid: true,
      value: "2026-08-16",
    });
  });
  ...
  it("parses DD/MM/YYYY", () => {
    expect(parseDateStrict("16/08/2026")).toEqual({
      valid: true,
      value: "2026-08-16",
    });
    expect(parseDateStrict("01-02-2026")).toEqual({
      valid: true,
      value: "2026-02-01",
    });
  });
  ...
  it("parses Excel serial dates", () => {
    // 44197 is Jan 1, 2021
    expect(parseDateStrict(44197)).toEqual({
      valid: true,
      value: "2021-01-01",
    });
  });
