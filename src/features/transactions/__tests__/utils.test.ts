...
describe("getTransactionPerspective", () => {
  it("computes InternalTransfer perspective relative to account", () => {
    ...
    expect(getTransactionPerspective(tx, "A")).toEqual({
      type: "outgoing",
      sign: "-",
      color: "text-foreground",
    });
    expect(getTransactionPerspective(tx, "B")).toEqual({
      type: "incoming",
      sign: "+",
      color: "text-emerald-500 dark:text-emerald-400",
    });
    expect(getTransactionPerspective(tx, "all")).toEqual({
      type: "neutral",
      sign: "⇄ ",
  ...
  it("handles normal Debits and Credits", () => {
    expect(
      getTransactionPerspective(
        { direction: "Credit", accountId: "A", destinationAccountId: "" },
        "A",
      ),
    ).toEqual({
      type: "incoming",
    ...
    expect(
      getTransactionPerspective(
        { direction: "Debit", accountId: "A", destinationAccountId: "" },
        "A",
      ),
    ).toEqual({ type: "outgoing", sign: "-", color: "text-foreground" });
  });
});
...
describe("filterTransactions", () => {
  ...
  it("filters InternalTransfer for both accounts", () => {
    const resA = filterTransactions(txs, {
      search: "",
      directionFilter: "all",
      accountFilter: "A",
      categoryFilter: "all",
    ...
    const resB = filterTransactions(txs, {
      search: "",
      directionFilter: "all",
      accountFilter: "B",
      categoryFilter: "all",
    ...
    const resC = filterTransactions(txs, {
      search: "",
      directionFilter: "all",
      accountFilter: "C",
      categoryFilter: "all",
  ...
  it("combines direction filters correctly with account filters", () => {
    ...
    const res1 = filterTransactions(txs, {
      search: "",
      directionFilter: "InternalTransfer",
      accountFilter: "B",
      categoryFilter: "all",
    });
    ...
    const res2 = filterTransactions(txs, {
      search: "",
    ...
    const res3 = filterTransactions(txs, {
      search: "",
    ...
    const res4 = filterTransactions(txs, {
      search: "",
      directionFilter: "Debit",
      accountFilter: "A",
      categoryFilter: "all",
