...
export const resetAndSeedDatabase = authActionClient.action(async ({ ctx: { userId } }) => {
  try {
    ...
    // 4. Create Categories
    const categoryNames = [
      { name: "Phone", type: "Expense", directionHint: "Debit", color: "#3B82F6" },
      { name: "DECO", type: "Expense", directionHint: "Debit", color: "#6366F1" },
      { name: "ChatGPT", type: "Expense", directionHint: "Debit", color: "#10B981" },
      { name: "Fuel", type: "Expense", directionHint: "Debit", color: "#F59E0B" },
      { name: "Gym", type: "Expense", directionHint: "Debit", color: "#EC4899" },
      { name: "Trips", type: "Expense", directionHint: "Debit", color: "#8B5CF6" },
      { name: "Family", type: "Expense", directionHint: "Debit", color: "#EF4444" },
      { name: "Health Insurance", type: "Expense", directionHint: "Debit", color: "#14B8A6" },
      { name: "Car Insurance", type: "Expense", directionHint: "Debit", color: "#F97316" },
      { name: "Car Maintenance", type: "Expense", directionHint: "Debit", color: "#64748B" },
      { name: "Food", type: "Expense", directionHint: "Debit", color: "#A855F7" },
      { name: "Leisure", type: "Expense", directionHint: "Debit", color: "#06B6D4" },
      { name: "Salary", type: "Income", directionHint: "Credit", color: "#22C55E" },
      { name: "Investment Profit", type: "Interest", directionHint: "Credit", color: "#EAB308" },
      { name: "Tax Reservation", type: "Tax", directionHint: "Debit", color: "#EF4444" },
      { name: "Other", type: "Expense", directionHint: "Both", color: "#94A3B8" },
      { name: "Internal Transfer", type: "Transfer", directionHint: "Both", color: "#9CA3AF" },
    ];
