...
export function InvestmentsClient({ data }: InvestmentsClientProps) {
  ...
  const defaultTab = validTabs.includes(queryTab || "")
    ? (queryTab as any)
    : "portfolio";
  const [activeTab, setActiveTab] = useState<"portfolio" | "activity">(
    defaultTab,
  );
  ...
  const totalKnownCost = data.investments.reduce(
    (sum, inv) => sum + (inv.costBasis != null ? inv.costBasis : 0),
    0,
  );
  const unknownCostCount = data.investments.filter(
    (inv) => inv.costBasis == null,
  ).length;
  const totalProfit =
    unknownCostCount === 0 ? totalValue - totalKnownCost : null;
  const profitPercentage =
    totalKnownCost > 0 && totalProfit != null
      ? (totalProfit / totalKnownCost) * 100
      : 0;
            ...
            <Card className="border-border bg-card/50 shadow-sm">
              ...
              <CardContent>
                ...
                <p className="text-[10px] text-muted-foreground mt-1 font-semibold">
                  Sum of all investment assets current valuation
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2 border-border bg-card/50 shadow-sm">
              <CardHeader>
                ...
                <CardDescription className="text-xs text-muted-foreground">
                  Compare invested capital to current valuation per asset type
                </CardDescription>
              </CardHeader>
            ...
            <Card className="border-border bg-card/50 shadow-sm">
              <CardHeader>
                ...
                <CardDescription className="text-xs text-muted-foreground">
                  Percentage share of total portfolio value
                </CardDescription>
              </CardHeader>
            ...
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription className="text-xs text-muted-foreground mt-1">
                  Individual asset valuations and performance records
                </CardDescription>
              </div>
              <Button
                size="sm"
            ...
            <DialogContent className="border-border bg-background">
              <form onSubmit={handleSave}>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Modify parameters and pricing metrics for{" "}
                    {selectedInv?.name}.
                  </DialogDescription>
                </DialogHeader>
                    ...
                    {selectedInv?.accountId == null &&
                      form.accountId === "unassigned" && (
                        <p className="text-[10px] text-muted-foreground">
                          This is a legacy holding. Assign it to a Broker or
                          Crypto Wallet when known.
                        </p>
                      )}
                  </div>
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, costBasis: e.target.value })
                        }
                      />
                    </div>
            ...
            <DialogContent className="border-border bg-background">
              <form onSubmit={handleCreate}>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Input parameters and pricing metrics for your new holding.
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {investmentAccounts.length === 0 && (
                      <p className="text-[10px] text-destructive">
                        Create a Broker or Crypto Wallet account before adding
                        an investment.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setAddForm({ ...addForm, costBasis: e.target.value })
                        }
                      />
                    </div>
                ...
                <DialogFooter>
                  ...
                  <Button
                    type="submit"
                    size="sm"
                    disabled={isPending || !addForm.accountId}
                  >
