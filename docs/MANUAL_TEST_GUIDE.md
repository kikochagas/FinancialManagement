...
- **Steps:** 2. Edit the transfer destination from B to C.
...
- **Steps:** 3. Change the filter to "Main Account".
- **Expected Result:** The transfer appears as outgoing.
- **Steps:** 4. Change the filter to "Trade Republic".
...
- **Steps:** 3. Change Direction filter to "Credit".
...
- **Steps:** 2. Import a statement with "Update Account Balance" set to ON.
...
- **Steps:** 2. Disconnect the account, then attempt to delete it.
...
_(Optional — requires an existing legacy backup file)_
