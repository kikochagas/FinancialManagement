  ...
  it("avoids accidental substring matches for short keywords", async () => {
    const transactions = [
      ...
      }, // NOT Tax
      {
        ...
        direction: "Debit" as const,
      }, // NOT Tax (irs substring in first)
      {
        candidateIndex: 3,
        description: "Account fee",
        direction: "Debit" as const,
